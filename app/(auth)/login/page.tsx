      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 w-full max-w-sm p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Two-factor authentication</p>
          </div>
          ...
          <form onSubmit={handleTOTP} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-3 text-center text-xl tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="000000"
              />
            </div>
            <button
